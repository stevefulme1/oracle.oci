...
"""Ansible module for retrieving OCI group information."""
...
short_description: Retrieve information about OCI groups
description:
    - Retrieve details about one or more groups in Oracle Cloud Infrastructure.
    - Use I(group_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    group_id:
        description:
            - The OCID of a specific group to retrieve.
...
EXAMPLES = r"""
- name: List all groups in a compartment
  stevefulme1.oci_cloud.oci_group_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific group by ID
  stevefulme1.oci_cloud.oci_group_info:
...
def get_resource(client, module):
    ...
    resource_id = module.params["group_id"]
    try:
        response = client.get_group(resource_id)
...
def main():
    ...
    module.exit_json(changed=False, groups=resources)
