...
"""Ansible module for retrieving OCI job information."""
...
DOCUMENTATION = r"""
---
module: oci_data_science_job_info
short_description: Retrieve information about OCI jobs
description:
    - Retrieve details about one or more jobs in Oracle Cloud Infrastructure.
    - Use I(job_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    job_id:
        description:
            - The OCID of a specific job to retrieve.
...
EXAMPLES = r"""
- name: List all jobs in a compartment
  stevefulme1.oci_cloud.oci_data_science_job_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific job by ID
  stevefulme1.oci_cloud.oci_data_science_job_info:
    job_id: "ocid1.job.oc1..example"
  register: result
"""
...
def get_resource(client, module):
    ...
    resource_id = module.params["job_id"]
    try:
        response = client.get_job(resource_id)
