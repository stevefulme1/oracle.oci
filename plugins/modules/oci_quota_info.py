...
"""Ansible module for retrieving OCI quota information."""
...
DOCUMENTATION = r"""
---
module: oci_quota_info
short_description: Retrieve information about OCI quotas
description:
    - Retrieve details about one or more quotas in Oracle Cloud Infrastructure.
    - Use I(quota_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    quota_id:
        description:
            - The OCID of a specific quota to retrieve.
...
EXAMPLES = r"""
- name: List all quotas in a compartment
  stevefulme1.oci_cloud.oci_quota_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific quota by ID
  stevefulme1.oci_cloud.oci_quota_info:
...
def get_resource(client, module):
    ...
    resource_id = module.params["quota_id"]
    try:
        response = client.get_quota(resource_id)
...
def main():
    ...
    client = create_service_client(module, oci.limits.QuotasClient)

    if module.params.get("quota_id"):
