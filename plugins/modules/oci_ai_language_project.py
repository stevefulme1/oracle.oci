...
"""Ansible module for managing OCI AI Language Projects."""
...
short_description: Manage AI Language Projects in OCI
description:
    - Create, update, and delete AI Language Projects in Oracle Cloud Infrastructure.
...
options:
    ...
    project_id:
        description:
            - The OCID of an existing AI Language project.
...
EXAMPLES = r"""
- name: Create an AI Language project
  stevefulme1.oci_cloud.oci_ai_language_project:
    compartment_id: "ocid1.compartment.oc1..example"
    display_name: "my-language-project"
    state: present

- name: Delete an AI Language project
  stevefulme1.oci_cloud.oci_ai_language_project:
...
RETURN = r"""
ai_language_project:
    description: Details of the AI Language project.
    returned: On success when state is present.
    type: dict
    sample:
        id: "ocid1.ailanguageproject.oc1..example"
        display_name: "my-language-project"
...
def main():
    ...
    if existing is None:
        for req in ("compartment_id", "display_name"):
            if not params.get(req):
                module.fail_json(msg=f"Parameter '{req}' is required to create an AI Language project.")
        if module.check_mode:
            module.exit_json(changed=True)
        resource = create_resource(module, client)
        module.exit_json(changed=True, ai_language_project=to_dict(resource))
        return
    ...
    module.exit_json(changed=False, ai_language_project=to_dict(existing))
