...
"""Ansible module for retrieving OCI pipeline information."""
...
DOCUMENTATION = r"""
---
module: oci_data_science_pipeline_info
short_description: Retrieve information about OCI pipelines
description:
    - Retrieve details about one or more pipelines in Oracle Cloud Infrastructure.
    - Use I(pipeline_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    pipeline_id:
        description:
            - The OCID of a specific pipeline to retrieve.
...
EXAMPLES = r"""
- name: List all pipelines in a compartment
  stevefulme1.oci_cloud.oci_data_science_pipeline_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific pipeline by ID
  stevefulme1.oci_cloud.oci_data_science_pipeline_info:
    pipeline_id: "ocid1.pipeline.oc1..example"
  register: result
"""

RETURN = r"""
pipelines:
    description: List of pipeline details.
    returned: always
    type: list
    elements: dict
"""
...
def get_resource(client, module):
    ...
    resource_id = module.params["pipeline_id"]
    try:
        response = client.get_pipeline(resource_id)
...
def main():
    ...
    if module.params.get("pipeline_id"):
        resources = get_resource(client, module)
    else:
        resources = list_resources(client, module)

    module.exit_json(changed=False, pipelines=resources)
