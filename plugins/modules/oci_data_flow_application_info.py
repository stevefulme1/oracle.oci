...
DOCUMENTATION = r"""
---
module: oci_data_flow_application_info
...
- name: List all applications in a compartment
  stevefulme1.oci_cloud.oci_data_flow_application_info:
...
def main():
    ...
    client = create_service_client(module, oci.data_flow.DataFlowClient)
