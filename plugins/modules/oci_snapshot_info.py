...
"""Ansible module for retrieving OCI snapshot information."""
...
DOCUMENTATION = r"""
---
module: oci_snapshot_info
short_description: Retrieve information about OCI snapshots
description:
    - Retrieve details about one or more snapshots in Oracle Cloud Infrastructure.
    - Use I(snapshot_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    snapshot_id:
        description:
            - The OCID of a specific snapshot to retrieve.
...
EXAMPLES = r"""
- name: List all snapshots in a compartment
  stevefulme1.oci_cloud.oci_snapshot_info:
...
def get_resource(client, module):
    ...
    resource_id = module.params["snapshot_id"]
    try:
        response = client.get_snapshot(resource_id)
