...
"""Ansible module for retrieving OCI compartment information."""
...
EXAMPLES = r    limit:
    ...
    max_results:
        ...
        default: 1000
"""
- name: List all compartments in a compartment
  stevefulme1.oci_cloud.oci_compartment_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific compartment by ID
  stevefulme1.oci_cloud.oci_compartment_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result
"""
...
def list_resources(client, module):
    """List compartments in a compartment."""
...
def get_resource(client, module):
    ...
    resource_id = module.params["compartment_id"]
    try:
        response = client.get_compartment(resource_id)
...
def main():
    ...
    if module.params.get("compartment_id"):
        resources = get_resource(client, module)
    else:
        resources = list_resources(client, module)

    module.exit_json(changed=False, compartments=resources)
