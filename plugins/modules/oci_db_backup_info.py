...
"""Ansible module for retrieving OCI backup information."""
...
DOCUMENTATION = r"""
---
module: oci_db_backup_info
short_description: Retrieve information about OCI backups
description:
    - Retrieve details about one or more backups in Oracle Cloud Infrastructure.
    - Use I(backup_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    backup_id:
        description:
            - The OCID of a specific backup to retrieve.
...
EXAMPLES = r"""
- name: List all backups in a compartment
  stevefulme1.oci_cloud.oci_db_backup_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific backup by ID
  stevefulme1.oci_cloud.oci_db_backup_info:
    backup_id: "ocid1.backup.oc1..example"
  register: result
"""

RETURN = r"""
backups:
    description: List of backup details.
    returned: always
    type: list
    elements: dict
"""
...
def get_resource(client, module):
    ...
    resource_id = module.params["backup_id"]
    try:
        response = client.get_backup(resource_id)
