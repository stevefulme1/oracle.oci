...
"""Ansible module for retrieving OCI log information."""
...
---
module: oci_log_info
short_description: Retrieve information about OCI logs
description:
    - Retrieve details about one or more logs in Oracle Cloud Infrastructure.
    - Use I(log_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    log_id:
        description:
            - The OCID of a specific log to retrieve.
...
EXAMPLES = r"""
- name: List all logs in a compartment
  stevefulme1.oci_cloud.oci_log_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific log by ID
  stevefulme1.oci_cloud.oci_log_info:
...
def get_resource(client, module):
    ...
    resource_id = module.params["log_id"]
    try:
        response = client.get_log(resource_id)
