...
"""Ansible module for managing OCI Data Science Models."""
...
short_description: Manage Data Science Models in OCI
description:
    - Create, update, and delete Data Science Models in Oracle Cloud Infrastructure.
...
EXAMPLES = r"""
- name: Create a Data Science model
  stevefulme1.oci_cloud.oci_data_science_model:
    compartment_id: "ocid1.compartment.oc1..example"
    display_name: "my-model"
    project_id: "ocid1.datascienceproject.oc1..example"
    state: present

- name: Delete a Data Science model
  stevefulme1.oci_cloud.oci_data_science_model:
...
RETURN = r"""
data_science_model:
    description: Details of the Data Science model.
    returned: On success when state is present.
    type: dict
    sample:
        id: "ocid1.datasciencemodel.oc1..example"
        display_name: "my-model"
...
def main():
    ...
    if existing is None:
        for req in ("compartment_id", "display_name", "project_id"):
            if not params.get(req):
                module.fail_json(msg=f"Parameter '{req}' is required to create a Data Science model.")
        if module.check_mode:
            module.exit_json(changed=True)
        resource = create_resource(module, client)
        module.exit_json(changed=True, data_science_model=to_dict(resource))
        return
    ...
    module.exit_json(changed=False, data_science_model=to_dict(existing))
