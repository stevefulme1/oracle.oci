...
DOCUMENTATION = r"""
---
module: oci_fault_domain_info
short_description: List OCI fault domains
description:
    - Retrieve information about fault domains in an availability domain.
...
EXAMPLES = r"""
- name: List fault domains
  stevefulme1.oci_cloud.oci_fault_domain_info:
