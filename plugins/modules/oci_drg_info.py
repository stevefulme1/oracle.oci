...
"""Ansible module for retrieving OCI drg information."""
...
---
module: oci_drg_info
short_description: Retrieve information about OCI drgs
description:
    - Retrieve details about one or more drgs in Oracle Cloud Infrastructure.
    - Use I(drg_id) to get a single resource, or I(compartment_id) to list resources.
...
- name: List all drgs in a compartment
  stevefulme1.oci_cloud.oci_drg_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific drg by ID
  stevefulme1.oci_cloud.oci_drg_info:
...
def get_resource(client, module):
    """Get a single drg by ID."""
    resource_id = module.params["drg_id"]
    try:
        response = client.get_drg(resource_id)
