...
"""Ansible module for retrieving OCI vcn information."""
...
---
module: oci_vcn_info
short_description: Retrieve information about OCI vcns
description:
    - Retrieve details about one or more vcns in Oracle Cloud Infrastructure.
    - Use I(vcn_id) to get a single resource, or I(compartment_id) to list resources.
...
- name: List all vcns in a compartment
  stevefulme1.oci_cloud.oci_vcn_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific vcn by ID
  stevefulme1.oci_cloud.oci_vcn_info:
...
def get_resource(client, module):
    """Get a single vcn by ID."""
    resource_id = module.params["vcn_id"]
    try:
        response = client.get_vcn(resource_id)
...
def main():
    ...
    module.exit_json(changed=False, vcns=resources)
