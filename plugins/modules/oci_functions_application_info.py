...
"""Ansible module for retrieving OCI application information."""
...
DOCUMENTATION = r"""
---
module: oci_functions_application_info
short_description: Retrieve information about OCI applications
description:
    - Retrieve details about one or more applications in Oracle Cloud Infrastructure.
    - Use I(application_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    application_id:
        description:
            - The OCID of a specific application to retrieve.
...
EXAMPLES = r"""
- name: List all applications in a compartment
  stevefulme1.oci_cloud.oci_functions_application_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific application by ID
  stevefulme1.oci_cloud.oci_functions_application_info:
    application_id: "ocid1.application.oc1..example"
  register: result
"""
...
def get_resource(client, module):
    ...
    resource_id = module.params["application_id"]
    try:
        response = client.get_application(resource_id)
...
def main():
    ...
    module.exit_json(changed=False, applications=resources)
