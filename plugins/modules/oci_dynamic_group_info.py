...
"""Ansible module for retrieving OCI dynamic group information."""
...
DOCUMENTATION = r"""
---
module: oci_dynamic_group_info
short_description: Retrieve information about OCI dynamic groups
description:
    - Retrieve details about one or more dynamic groups in Oracle Cloud Infrastructure.
    - Use I(dynamic_group_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    dynamic_group_id:
        description:
            - The OCID of a specific dynamic group to retrieve.
...
EXAMPLES = r"""
- name: List all dynamic groups in a compartment
  stevefulme1.oci_cloud.oci_dynamic_group_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific dynamic group by ID
  stevefulme1.oci_cloud.oci_dynamic_group_info:
    dynamic_group_id: "ocid1.dynamic_group.oc1..example"
  register: result
"""
...
def list_resources(client, module):
    """List dynamic groups in a compartment."""
...
def get_resource(client, module):
    ...
    resource_id = module.params["dynamic_group_id"]
    try:
        response = client.get_dynamic_group(resource_id)
...
def main():
    ...
    module = AnsibleModule(
        ...
        required_one_of=[
            ("compartment_id", "dynamic_group_id"),
        ],
    )
    ...
    if module.params.get("dynamic_group_id"):
        resources = get_resource(client, module)
    else:
        resources = list_resources(client, module)

    module.exit_json(changed=False, dynamic_groups=resources)
