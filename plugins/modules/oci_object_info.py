...
DOCUMENTATION = r"""
---
module: oci_object_info
short_description: Retrieve object information
description:
    - Retrieve details about objects.
    - Read-only module.
version_added: "1.0.0"
author:
...
- name: List all objects
  stevefulme1.oci_cloud.oci_object_info:
