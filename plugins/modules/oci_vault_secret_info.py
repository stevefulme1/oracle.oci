...
"""Ansible module for retrieving OCI secret information."""
...
DOCUMENTATION = r"""
---
module: oci_vault_secret_info
short_description: Retrieve information about OCI secrets
description:
    - Retrieve details about one or more secrets in Oracle Cloud Infrastructure.
    - Use I(secret_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    secret_id:
        description:
            - The OCID of a specific secret to retrieve.
...
EXAMPLES = r"""
- name: List all secrets in a compartment
  stevefulme1.oci_cloud.oci_vault_secret_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific secret by ID
  stevefulme1.oci_cloud.oci_vault_secret_info:
...
RETURN = r"""
secrets:
    description: List of secret details.
    returned: always
    type: list
    elements: dict
"""
...
def get_resource(client, module):
    ...
    resource_id = module.params["secret_id"]
    try:
        response = client.get_secret(resource_id)
...
def main():
    ...
    client = create_service_client(module, oci.vault.VaultsClient)

    if module.params.get("secret_id"):
