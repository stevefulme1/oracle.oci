...
"""Ansible module for managing OCI AI Document Understanding Models."""
...
short_description: Manage AI Document Understanding Models in OCI
description:
    - Create, update, and delete AI Document Understanding Models in Oracle Cloud Infrastructure.
...
options:
    ...
    model_id:
        description:
            - The OCID of an existing document model.
            - Required for update and delete operations.
        type: str
    project_id:
        description:
            - The OCID of the document understanding project the model belongs to.
            - Required when creating a new model.
        type: str
    display_name:
        description:
    ...
    model_type:
        description:
            - The type of document model to create.
        type: str
        choices:
    ...
    training_dataset:
        description:
            - The training dataset details for the model.
        type: dict
    state:
        description:
...
- name: Create a Document Understanding model
  stevefulme1.oci_cloud.oci_ai_document_model:
    compartment_id: "ocid1.compartment.oc1..example"
    project_id: "ocid1.aidocumentproject.oc1..example"
    display_name: "my-document-model"
...
- name: Delete a Document Understanding model
  stevefulme1.oci_cloud.oci_ai_document_model:
    model_id: "ocid1.aidocumentmodel.oc1..example"
    state: absent
"""

RETURN = r"""
ai_document_model:
    description: Details of the Document Understanding model.
    returned: On success when state is present.
    type: dict
    sample:
        id: "ocid1.aidocumentmodel.oc1..example"
        display_name: "my-document-model"
...
def get_module_args():
    module_args = dict(
        ...
        model_type=dict(type="str", choices=["KEY_VALUE_EXTRACTION", "DOCUMENT_CLASSIFICATION"]),
...
def main():
    ...
    if existing is None:
        for req in ("compartment_id", "project_id"):
            if not params.get(req):
                module.fail_json(msg=f"Parameter '{req}' is required to create a document model.")
        if module.check_mode:
            module.exit_json(changed=True)
        resource = create_resource(module, client)
        module.exit_json(changed=True, ai_document_model=to_dict(resource))
        return
    ...
    module.exit_json(changed=False, ai_document_model=to_dict(existing))
