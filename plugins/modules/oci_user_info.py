...
"""Ansible module for retrieving OCI user information."""
...
short_description: Retrieve information about OCI users
description:
    - Retrieve details about one or more users in Oracle Cloud Infrastructure.
    - Use I(user_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    user_id:
        description:
            - The OCID of a specific user to retrieve.
...
EXAMPLES = r"""
- name: List all users in a compartment
  stevefulme1.oci_cloud.oci_user_info:
...
def get_resource(client, module):
    ...
    resource_id = module.params["user_id"]
    try:
        response = client.get_user(resource_id)
