...
DOCUMENTATION = r"""
---
module: oci_generative_ai_dedicated_ai_cluster
...
options:
    ...
    description:
        description:
            - A description of the dedicated AI cluster.
        type: str
    cluster_type:
        description:
            - The type of the dedicated AI cluster.
        type: str
        choices:
            - HOSTING
            - FINE_TUNING
    ...
    unit_shape:
        description:
            - The shape of each unit in the cluster.
        type: str
    state:
        description:
...
EXAMPLES = r"""
- name: Create a Dedicated AI Cluster for hosting
  stevefulme1.oci_cloud.oci_generative_ai_dedicated_ai_cluster:
...
- name: Delete a Dedicated AI Cluster
  stevefulme1.oci_cloud.oci_generative_ai_dedicated_ai_cluster:
    dedicated_ai_cluster_id: "ocid1.integratedaicluster.oc1..example"
    state: absent
"""

RETURN = r"""
dedicated_ai_cluster:
    description: Details of the Dedicated AI Cluster.
    returned: On success when state is present.
    type: dict
    sample:
        id: "ocid1.integratedaicluster.oc1..example"
        display_name: "my-hosting-cluster"
...
def get_module_args():
    module_args = dict(
        ...
        cluster_type=dict(type="str", choices=["HOSTING", "FINE_TUNING"]),
...
def create_resource(module, client):
    ...
    create_details = CreateDedicatedAiClusterDetails(
        ...
        type=params.get("cluster_type"),
        unit_count=params.get("unit_count"),
        unit_shape=params.get("unit_shape"),
...
def update_resource(module, client, existing):
    params = module.params
    update_details = UpdateDedicatedAiClusterDetails(
        display_name=params.get("display_name"),
        description=params.get("description"),
        unit_count=params.get("unit_count"),
        freeform_tags=params.get("freeform_tags"),
...
def main():
    module = AnsibleModule(
        ...
        required_if=[
            ("state", "present", ("compartment_id", "cluster_type", "unit_count", "unit_shape"), True),
        ],
    )
    ...
    if existing is None:
        ...
        module.exit_json(changed=True, dedicated_ai_cluster=to_dict(resource))
        return
    ...
    module.exit_json(changed=False, dedicated_ai_cluster=to_dict(existing))
