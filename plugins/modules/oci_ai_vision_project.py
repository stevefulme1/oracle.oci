...
"""Ansible module for managing OCI AI Vision Projects."""
...
short_description: Manage AI Vision Projects in OCI
description:
    - Create, update, and delete AI Vision Projects in Oracle Cloud Infrastructure.
...
options:
    ...
    project_id:
        description:
            - The OCID of an existing AI Vision project.
...
EXAMPLES = r"""
- name: Create an AI Vision project
  stevefulme1.oci_cloud.oci_ai_vision_project:
    compartment_id: "ocid1.compartment.oc1..example"
    display_name: "my-vision-project"
    state: present

- name: Delete an AI Vision project
  stevefulme1.oci_cloud.oci_ai_vision_project:
...
RETURN = r"""
ai_vision_project:
    description: Details of the AI Vision project.
...
def main():
    ...
    if existing is None:
        for req in ("compartment_id", "display_name"):
            if not params.get(req):
                module.fail_json(msg=f"Parameter '{req}' is required to create an AI Vision project.")
        if module.check_mode:
            module.exit_json(changed=True)
        resource = create_resource(module, client)
        module.exit_json(changed=True, ai_vision_project=to_dict(resource))
        return
    ...
    module.exit_json(changed=False, ai_vision_project=to_dict(existing))
