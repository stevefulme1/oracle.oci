...
"""Ansible module for retrieving OCI model deployment information."""
...
DOCUMENTATION = r"""
---
module: oci_data_science_model_deployment_info
short_description: Retrieve information about OCI model deployments
description:
    - Retrieve details about one or more model deployments in Oracle Cloud Infrastructure.
    - Use I(model_deployment_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    model_deployment_id:
        description:
            - The OCID of a specific model deployment to retrieve.
...
EXAMPLES = r    limit:
    ...
    max_results:
        ...
        default: 1000
"""
- name: List all model deployments in a compartment
  stevefulme1.oci_cloud.oci_data_science_model_deployment_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific model deployment by ID
  stevefulme1.oci_cloud.oci_data_science_model_deployment_info:
    model_deployment_id: "ocid1.model_deployment.oc1..example"
  register: result
"""

RETURN = r"""
model_deployments:
    description: List of model deployment details.
    returned: always
    type: list
    elements: dict
"""
...
def get_resource(client, module):
    ...
    resource_id = module.params["model_deployment_id"]
    try:
        response = client.get_model_deployment(resource_id)
...
def main():
    ...
    module = AnsibleModule(
        ...
        required_one_of=[
            ("compartment_id", "model_deployment_id"),
        ],
    )
    ...
    if module.params.get("model_deployment_id"):
        resources = get_resource(client, module)
    else:
        resources = list_resources(client, module)

    module.exit_json(changed=False, model_deployments=resources)
