...
"""oci_container_scan_recipe_info module."""
...
DOCUMENTATION = r"""
---
module: oci_container_scan_recipe_info
short_description: Retrieve container scan recipe information
description:
    - Retrieve details about container scan recipes.
    - Read-only module.
version_added: "1.0.0"
author:
...
- name: Get specific container scan recipe
  stevefulme1.oci_cloud.oci_container_scan_recipe_info:
    host: api.example.com
...
def main():
    ...
    module.exit_json(changed=False, container_scan_recipes=[])
