...
"""Ansible module for managing OCI AI Document Understanding Projects."""
...
short_description: Manage AI Document Understanding Projects in OCI
description:
    - Create, update, and delete AI Document Understanding Projects in Oracle Cloud Infrastructure.
...
options:
    ...
    project_id:
        description:
            - The OCID of an existing document understanding project.
...
EXAMPLES = r"""
- name: Create a Document Understanding project
  stevefulme1.oci_cloud.oci_ai_document_project:
    compartment_id: "ocid1.compartment.oc1..example"
    display_name: "my-document-project"
    state: present

- name: Delete a Document Understanding project
  stevefulme1.oci_cloud.oci_ai_document_project:
...
RETURN = r"""
ai_document_project:
    description: Details of the Document Understanding project.
    returned: On success when state is present.
    type: dict
    sample:
        id: "ocid1.aidocumentproject.oc1..example"
        display_name: "my-document-project"
...
def main():
    ...
    if existing is None:
        ...
        module.exit_json(changed=True, ai_document_project=to_dict(resource))
        return
    ...
    module.exit_json(changed=False, ai_document_project=to_dict(existing))
