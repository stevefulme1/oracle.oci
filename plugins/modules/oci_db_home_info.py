...
"""Ansible module for retrieving OCI db home information."""
...
DOCUMENTATION = r"""
---
module: oci_db_home_info
short_description: Retrieve information about OCI db homes
description:
    - Retrieve details about one or more db homes in Oracle Cloud Infrastructure.
    - Use I(db_home_id) to get a single resource, or I(compartment_id) to list resources.
...
options:
    ...
    db_home_id:
        description:
            - The OCID of a specific db home to retrieve.
...
EXAMPLES = r"""
- name: List all db homes in a compartment
  stevefulme1.oci_cloud.oci_db_home_info:
    compartment_id: "ocid1.compartment.oc1..example"
  register: result

- name: Get a specific db home by ID
  stevefulme1.oci_cloud.oci_db_home_info:
    db_home_id: "ocid1.db_home.oc1..example"
  register: result
"""

RETURN = r"""
db_homes:
    description: List of db home details.
    returned: always
    type: list
    elements: dict
"""
...
def list_resources(client, module):
    """List db homes in a compartment."""
...
def get_resource(client, module):
    """Get a single db home by ID."""
    resource_id = module.params["db_home_id"]
    try:
        response = client.get_db_home(resource_id)
...
def main():
    ...
    if module.params.get("db_home_id"):
        resources = get_resource(client, module)
    else:
        resources = list_resources(client, module)

    module.exit_json(changed=False, db_homes=resources)
