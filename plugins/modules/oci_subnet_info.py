...
"""Ansible module for retrieving OCI subnet information."""
...
short_description: Retrieve information about OCI subnets
description:
    - Retrieve details about one or more subnets in Oracle Cloud Infrastructure.
    - Use I(subnet_id) to get a single resource, or I(compartment_id) to list resources.
...
- name: List all subnets in a compartment
  stevefulme1.oci_cloud.oci_subnet_info:
...
def get_resource(client, module):
    ...
    resource_id = module.params["subnet_id"]
    try:
        response = client.get_subnet(resource_id)
...
def main():
    ...
    module.exit_json(changed=False, subnets=resources)
