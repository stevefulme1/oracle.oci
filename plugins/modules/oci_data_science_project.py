...
"""Ansible module for managing OCI Data Science Projects."""
...
short_description: Manage Data Science Projects in OCI
description:
    - Create, update, and delete Data Science Projects in Oracle Cloud Infrastructure.
...
options:
    ...
    project_id:
        description:
            - The OCID of an existing Data Science project.
...
- name: Create a Data Science project
  stevefulme1.oci_cloud.oci_data_science_project:
    compartment_id: "ocid1.compartment.oc1..example"
    display_name: "my-ds-project"
    description: "Data Science project"
    state: present

- name: Delete a Data Science project
  stevefulme1.oci_cloud.oci_data_science_project:
...
data_science_project:
    description: Details of the Data Science project.
    returned: On success when state is present.
    type: dict
    sample:
        id: "ocid1.datascienceproject.oc1..example"
        display_name: "my-ds-project"
    ...
    if existing is None:
        for req in ("compartment_id", "display_name"):
            if not params.get(req):
                module.fail_json(msg=f"Parameter '{req}' is required to create a Data Science project.")
        if module.check_mode:
            module.exit_json(changed=True)
        resource = create_resource(module, client)
        module.exit_json(changed=True, data_science_project=to_dict(resource))
        return
