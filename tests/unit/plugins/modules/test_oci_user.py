"""Unit tests for stevefulme1.oci_cloud.oci_user module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_user"
...
def _build_resource(**overrides):
    ...
    resource = MagicMock()
    resource.id = overrides.get("id", "ocid1.user.oc1..test")
    resource.name = overrides.get("name", "test-user")
...
class TestCreate:
    ...
    def test_create_resource(self, mock_create_client, create_args):
        ...
        from ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_user import OciUser
        obj = OciUser(module)
...
class TestErrorHandling:
    ...
    def test_auth_error(self, mock_create_client, create_args):
        ...
        import oci.exceptions
        mock_client.create_user.side_effect = oci.exceptions.ServiceError(
