"""Unit tests for stevefulme1.oci_cloud.oci_policy module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_policy"
...
def _build_resource(**overrides):
    ...
    resource = MagicMock()
    resource.id = overrides.get("id", "ocid1.policy.oc1..test")
    resource.name = overrides.get("name", "admin-policy")
...
class TestCreate:
    ...
    def test_create_resource(self, mock_create_client, create_args):
        ...
        from ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_policy import OciPolicy
        obj = OciPolicy(module)
        result = obj.create_resource()

        mock_client.create_policy.assert_called_once()
        assert result.name == "admin-policy"
...
class TestErrorHandling:
    ...
    def test_auth_error(self, mock_create_client, create_args):
        ...
        import oci.exceptions
        mock_client.create_policy.side_effect = oci.exceptions.ServiceError(
