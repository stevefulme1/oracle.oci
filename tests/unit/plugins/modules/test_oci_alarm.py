"""Unit tests for stevefulme1.oci_cloud.oci_alarm module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_alarm"
...
def _build_resource(**overrides):
    ...
    resource = MagicMock()
    resource.id = overrides.get("id", "ocid1.alarm.oc1..test")
    resource.display_name = overrides.get("display_name", "high-cpu")
...
def create_args(module_args):
    """Module args for creating a alarm."""
    module_args.update({
...
class TestCreate:
    ...
    def test_create_resource(self, mock_create_client, create_args):
        ...
        from ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_alarm import OciAlarm
        obj = OciAlarm(module)
        result = obj.create_resource()

        mock_client.create_alarm.assert_called_once()
        assert result.display_name == "high-cpu"
    ...
    def test_create_check_mode(self, mock_create_client, create_args):
        ...
        mock_client.create_alarm.assert_not_called()
...
class TestErrorHandling:
    ...
    def test_auth_error(self, mock_create_client, create_args):
        ...
        import oci.exceptions
        mock_client.create_alarm.side_effect = oci.exceptions.ServiceError(
