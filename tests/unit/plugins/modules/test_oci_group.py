"""Unit tests for stevefulme1.oci_cloud.oci_group module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_group"
...
def _build_resource(**overrides):
    ...
    resource = MagicMock()
    resource.id = overrides.get("id", "ocid1.group.oc1..test")
    resource.name = overrides.get("name", "admins")
...
class TestCreate:
    ...
    def test_create_resource(self, mock_create_client, create_args):
        ...
        from ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_group import OciGroup
        obj = OciGroup(module)
...
class TestErrorHandling:
    ...
    def test_auth_error(self, mock_create_client, create_args):
        ...
        import oci.exceptions
        mock_client.create_group.side_effect = oci.exceptions.ServiceError(
