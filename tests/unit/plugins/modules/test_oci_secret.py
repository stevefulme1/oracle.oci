"""Unit tests for stevefulme1.oci_cloud.oci_secret module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_secret"
RESOURCE_PATH = "ansible_collections.stevefulme1.oci_cloud.plugins.module_utils.oci_resource"


def _build_resource(**overrides):
    """Return a mock OCI secret object."""
    resource = MagicMock()
    resource.id = overrides.get("id", "ocid1.secret.oc1..test")
    resource.secret_name = overrides.get("secret_name", "db-password")
...
class TestCreate:
    ...
    def test_create_resource(self, mock_create_client, create_args):
        ...
        from ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_secret import OciSecret
        obj = OciSecret(module)
        result = obj.create_resource()

        mock_client.create_secret.assert_called_once()
        assert result.secret_name == "db-password"
...
class TestUpdate:
    ...
    def test_update_resource(self, mock_create_client, module_args):
        ...
        updated = _build_resource(secret_name="updated-name")
        mock_response = MagicMock()
        ...
        assert result.secret_name == "updated-name"
...
class TestErrorHandling:
    ...
    def test_auth_error(self, mock_create_client, create_args):
        ...
        import oci.exceptions
        mock_client.create_secret.side_effect = oci.exceptions.ServiceError(
