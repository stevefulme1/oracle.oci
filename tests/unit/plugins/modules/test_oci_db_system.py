"""Unit tests for stevefulme1.oci_cloud.oci_db_system module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_db_system"
...
def _build_resource(**overrides):
    ...
    resource = MagicMock()
    resource.id = overrides.get("id", "ocid1.db_system.oc1..test")
    resource.display_name = overrides.get("display_name", "My DBSystem")
...
def create_args(module_args):
    """Module args for creating a db_system."""
    module_args.update({
        "display_name": "My DBSystem",
...
class TestCreate:
    ...
    def test_create_resource(self, mock_create_client, create_args):
        ...
        from ansible_collections.stevefulme1.oci_cloud.plugins.modules.oci_db_system import OciDbSystem
        obj = OciDbSystem(module)
        result = obj.create_resource()

        mock_client.create_db_system.assert_called_once()
        assert result.display_name == "My DBSystem"
    ...
    def test_create_check_mode(self, mock_create_client, create_args):
        ...
        mock_client.create_db_system.assert_not_called()


class TestDelete:
    """Test db_system deletion."""
...
class TestErrorHandling:
    ...
    def test_auth_error(self, mock_create_client, create_args):
        ...
        import oci.exceptions
        mock_client.create_db_system.side_effect = oci.exceptions.ServiceError(
